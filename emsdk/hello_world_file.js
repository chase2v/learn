...
Module['FS_createPath']('/', 'tests', true, true);
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 199, "filename": "/tests/hello_world_file.txt"}], "remote_package_size": 199, "package_uuid": "a138c4f6-526d-43a3-9013-ad880352f0b3"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'hello_world_file.wast';
  var wasmBinaryFile = 'hello_world_file.wasm';
  var asmjsCodeFile = 'hello_world_file.temp.asm.js';
